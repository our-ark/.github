...
This document explores a philosophical parallel.

For the core belief system, read the [Manifesto](./manifesto.md). For the practical model, read the [World Model](./world-model.md).
